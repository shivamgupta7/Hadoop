...
def highest_average_idle_hours(els_obj ,index_name, path, top):
    '''
...
def main():
    es = Elasticsearch()
    highest_average_idle_hours(els_obj=es, index_name='user_log', path='data/high_avg_idle.csv',top=30)
