...
def complete_operation(directory, start_timing, end_timing, initial_time, df_total):
    '''
    In this function doing all operation(like:find start_time, end_time, join tables and uniun all tables and return all combine data frame into one data frame
    '''
    try:
